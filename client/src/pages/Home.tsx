...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      ...
      <footer className="mt-12 pb-6 text-center space-y-6">
        <div className="w-full max-w-2xl mx-auto h-px bg-border" />
        <div className="space-y-6">
          <a 
          ...
          <div className="space-y-2 text-sm text-muted-foreground">
            ...
            <p className="text-xs">Take to a human before making a huge financial decision.</p>
          </div>
        </div>
      </footer>
    </div>
