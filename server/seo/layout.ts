export function getLayout(title: string, metaDescription: string, content: string): string {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body class="min-h-screen bg-white font-noto-sans">
    <header class="w-full py-6 border-b border-border relative bg-white">
      <div class="container mx-auto px-4 md:px-4 lg:px-4 max-w-[1200px]">
        ...
        <!-- Mobile Menu -->
        <nav class="hidden md:hidden fixed left-0 right-0 top-[73px] bg-white border-b border-border py-4 px-4 shadow-lg z-[100]" id="mobile-menu">
